      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Eyebrow('$agency · Observer', color: context.pal.accent),
            const SizedBox(height: 8),
            Text('YOUR CONSOLE IS ON THE WEB', style: context.type.title),
            ...
            Text(
              ...
              style: context.type.meta.copyWith(height: 1.5),
            ),
          ],
        ),
      ),
